...
public class Presentation2 {
    public static void main(String[] args) throws Exception {
        ...
        ILigneCommandeProduiDao ligneDao = context.getBean("ligneCommandeProduitDaoImpl", ILigneCommandeProduiDao.class);
        ...
        ligne1.setId(new LigneCommandeProduitId(cmd1.getId(), p1.getId()));
        ...
        ligne2.setId(new LigneCommandeProduitId(cmd1.getId(), p2.getId()));
        ...
        ligne3.setId(new LigneCommandeProduitId(cmd1.getId(), p3.getId()));
        ligneDao.create(ligne3);
        */

//         ----- Test -----
        LigneCommandeProduitId id = new LigneCommandeProduitId(11, 16);
        LigneCommandeProduit l = ligneDao.findById(id);
